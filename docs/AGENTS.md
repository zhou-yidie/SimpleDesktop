...
## 3. 文档维护责任 (Documentation Maintenance)

> [!IMPORTANT]
> **文档即代码**。严禁出现功能已上线但文档未更新的情况。

- **功能同步**：任何新功能（Feature）的实现或旧逻辑的变更，必须同步在 `docs/` 下对应的 `.md` 文件中记录。
- **归口管理**：除 `README.md` 和 `AGENTS.md` 外，所有文档必须存放在 `docs/` 目录下。

## 4. 自我改进与学习 (Self-Improvement)
