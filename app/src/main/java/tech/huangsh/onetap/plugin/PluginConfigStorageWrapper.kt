...
class PluginConfigStorageWrapper(
    ...
    override fun observeChanges(): Flow<ConfigChange> {
        // 简化：仅作为占位符，后续可扩展为差异检测
        return dataStore.data.map { ConfigChange("", null, it) }
    }
